...
from networks.image_net import PolicyNetContinuous,ValueStateNet
...
class ActorCritic(nn.Module):
    def __init__(self, state_dim, action_dim, has_continuous_action_space, action_std_init):
        ...
        # actor部分：决定智能体的动作
        self.actor = PolicyNetContinuous(1, action_dim)

        # critic部分：估计状态值
        self.critic = ValueStateNet(1)  # 使用PointNetModel作为值网络，输出1个值
